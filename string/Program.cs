        ...
        if (aliceSentenceSearch.IndexOf(searchTerm) != -1)
            {
                ...
                //I hope this is covered in class, these methods don't work in a way that I'm making sense out of.
                //string aliceSentenceEdit = aliceSentence.Substring(termEnd, remainingChars);
                Console.WriteLine($"String size {searchTerm.Length} found at index[{aliceSentenceSearch.IndexOf(searchTerm)}]");
                //Console.WriteLine(aliceSentenceEdit);
            }
        else
            {
